  ...
  var Enhancer = (function (_ComposedComponent) {
    ...
    _createClass(Enhancer, [{
      ...
      value: function componentWillUpdate() {
        ...
        _get(Object.getPrototypeOf(Enhancer.prototype), 'componentWillUpdate', this).apply(this, args);
        if (this.observe) {
      ...
      value: function componentWillReceiveProps(newProps, newContext) {
        _get(Object.getPrototypeOf(Enhancer.prototype), 'componentWillReceiveProps', this).call(this, newProps, newContext);
        if (this.observe) {
      ...
      value: function componentWillUnmount() {
        _get(Object.getPrototypeOf(Enhancer.prototype), 'componentWillUnmount', this).call(this);
      ...
      value: function _unsubscribe() {
        ...
        Object.keys(this._subscriptions).forEach(function (key) {
          return _this2._subscriptions[key].dispose();
        });
